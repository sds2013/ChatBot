...
public class Mbti_Entj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editText.getText().toString().isEmpty()){
                    Toast.makeText(Mbti_Entj.this,"메세지를 입력하세요",Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Mbti_Entj.this,"뒤로가기", Toast.LENGTH_SHORT);
                finish();
            }
        });
    }
    ...
    private void getResponse(String message) {
        ...
        String url = "\n" +
                "http://api.brainshop.ai/get?bid=170086&key=ZN732AYNO50K4WBV&uid=[uid]&msg="+message;
