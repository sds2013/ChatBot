...
public class Mbti_Enfj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editText.getText().toString().isEmpty()){
                    Toast.makeText(Mbti_Enfj.this,"메세지를 입력하세요",Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Mbti_Enfj.this,"뒤로가기", Toast.LENGTH_SHORT);
    ...
    private void getResponse(String message) {
        ...
        String url = "\n" +
                "http://api.brainshop.ai/get?bid=170088&key=qlyBZir93xhhX2tb&uid=[uid]&msg="+message;
