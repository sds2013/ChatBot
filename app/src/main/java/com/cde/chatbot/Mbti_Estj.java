...
public class Mbti_Estj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editText.getText().toString().isEmpty()){
                    Toast.makeText(Mbti_Estj.this,"메세지를 입력하세요",Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Mbti_Estj.this,"뒤로가기", Toast.LENGTH_SHORT);
                finish();
            }
        });
    }
    ...
    private void getResponse(String message) {
        ...
        String url = "\n" +
                "http://api.brainshop.ai/get?bid=170089&key=MOyiU9dmi4SNd98X&uid=[uid]&msg="+message;
